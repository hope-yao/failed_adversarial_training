...
def evaluate_checkpoint(filename):
  with tf.Session() as sess:
    ...
    import numpy as np
    np.save('adv',{'x_adv': np.concatenate(x_adv,0), 'y_adv': np.concatenate(y_adv,0)})
...
evaluate_checkpoint('/home/hope-yao/Documents/mnist_challenge_voting/models/a_very_robust_model_voting3/checkpoint-98000')
